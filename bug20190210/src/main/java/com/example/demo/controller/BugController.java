...
public class BugController {
    ...
    public String findAllByProjectName(Model model,int pid) {
        List<Bug> bugs = bugService.findAllByProjectName(pid);
    ...
    public String PageList(Model model, @RequestParam(value="pageon",defaultValue="1")int pageon) {
